...
import { Star, MapPin, ShieldCheck, Zap, Cpu, Video } from 'lucide-react';
  ...
  return (
    <section className="py-24 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl font-black text-[#1a1a1a] tracking-tight">
            Surprinde lumea de la <span className="text-[#00966d]">înălțime</span>
          </h2>
        </div>
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          <div className="relative z-10 bg-white p-4 sm:p-8 rounded-[3rem] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.12)] border border-gray-50 transform hover:scale-[1.02] transition-all duration-700 ease-out">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
              <div>
                <h3 className="text-2xl sm:text-3xl font-black text-[#1a1a1a] mb-2">DJI Mavic 3 Pro</h3>
            ...
            <div className="mt-8 pt-8 border-t border-gray-100 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-gray-200 overflow-hidden border-2 border-white shadow-sm">
                  <img src="https://i.pravatar.cc/100?u=drone_owner" alt="Owner" />
                </div>
                <div>
                  <div className="text-sm font-bold text-[#1a1a1a]">Alexandru G.</div>
                  <div className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Pilot Certificat</div>
                </div>
              </div>
          ...
          <div className="absolute -bottom-8 -left-8 sm:-left-16 z-20 bg-[#1a1a1a] text-white p-5 rounded-[2rem] shadow-2xl flex items-center gap-4 max-w-[240px] animate-bounce-slow">
            ...
            <div>
              <div className="font-bold text-sm">Asigurare Drone</div>
              <div className="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Protecție completă</div>
            </div>
          </div>
          ...
          <div className="absolute -top-12 -right-8 sm:-right-16 z-20 bg-white p-4 rounded-2xl shadow-xl border border-gray-100 flex items-center gap-4 animate-float">
            ...
            <div className="pr-4">
              <div className="text-[10px] font-black text-[#00966d] uppercase tracking-widest">Disponibil</div>
              <div className="text-sm font-bold text-[#1a1a1a]">Rezervare instant</div>
            </div>
          </div>
      ...
      <style>{`
        ...
        .animate-bounce-slow {
          animation: bounce-slow-drone 5s ease-in-out infinite;
        }
        .animate-float {
          animation: float-drone 7s ease-in-out infinite;
        }
      `}</style>
    </section>
  );
