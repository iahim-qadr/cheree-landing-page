...
import { Star, MapPin, ShieldCheck, Zap, Bike } from 'lucide-react';

const BicycleShowcase: React.FC = () => {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#00966d]/10 text-[#00966d] text-xs font-bold uppercase tracking-widest mb-6 border border-[#00966d]/20">
            ...
            Disponibil acum în comunitate
          </div>
          <h2 className="text-3xl sm:text-5xl font-black text-[#1a1a1a] tracking-tight">
            De la aventuri în oraș, la <span className="text-[#00966d]">trasee montane</span>
          </h2>
        </div>
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          <div className="relative z-10 bg-white p-4 sm:p-8 rounded-[3rem] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.12)] border border-gray-50 transform hover:scale-[1.02] transition-all duration-700 ease-out">
            <div className="relative rounded-[2.5rem] overflow-hidden aspect-[16/10] mb-8 group">
              <img 
                src="https://images.unsplash.com/photo-1576435728678-68d0fbf94e91?auto=format&fit=crop&q=80&w=1200" 
                alt="Specialized Mountain Bike" 
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
              <div>
                <h3 className="text-2xl sm:text-3xl font-black text-[#1a1a1a] mb-2">Specialized Rockhopper</h3>
            ...
            <div className="mt-8 pt-8 border-t border-gray-100 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-gray-200 overflow-hidden border-2 border-white shadow-sm">
                  <img src="https://i.pravatar.cc/100?u=bike_owner" alt="Owner" />
                </div>
                <div>
                  <div className="text-sm font-bold text-[#1a1a1a]">Mihai T.</div>
                  <div className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Superhost</div>
                </div>
              </div>
          ...
          <div className="absolute -bottom-8 -right-8 sm:-right-16 z-20 bg-[#1a1a1a] text-white p-5 rounded-[2rem] shadow-2xl flex items-center gap-4 max-w-[240px] animate-bounce-slow">
            ...
            <div>
              ...
              <div className="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Protecție totală</div>
            </div>
          </div>
          ...
          <div className="absolute -top-12 -left-8 sm:-left-16 z-20 bg-white p-4 rounded-2xl shadow-xl border border-gray-100 flex items-center gap-4 animate-float">
            ...
            <div className="pr-4">
              <div className="text-[10px] font-black text-[#00966d] uppercase tracking-widest">Popular</div>
              <div className="text-sm font-bold text-[#1a1a1a]">12 închirieri luna asta</div>
            </div>
          </div>
...
export default BicycleShowcase;
